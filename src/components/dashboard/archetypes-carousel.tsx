...
> = {
  entry: {
    emoji: "🔥",
    description: "Entra na frente de todo mundo — e morre na frente também.",
  ...
  clutch: {
    emoji: "🧠",
    description: "1v4 no pistol sem dinheiro? Problema de quem corre.",
  ...
  headshot: {
    emoji: "🎯",
    description: "Se não for HS, ele nem conta como kill.",
  ...
  consistent: {
    emoji: "🛡️",
    description: "Nunca foi o melhor, nunca foi o pior. Sempre estava lá.",
  ...
  impact: {
    emoji: "⚡",
    description: "Rating alto, dano alto, paciência do time a zero.",
    color: "text-primary",
    bg: "bg-primary/10",
  ...
  support: {
    emoji: "🤝",
    description: "Flash, smoke, assist — faz tudo menos aparecer no highlight.",
    color: "text-accent-violet",
    bg: "bg-accent-violet/10",
    border: "border-accent-violet/20",
  },
  tactician: {
    emoji: "🧩",
    description: "Faz tudo, especialista em nada, indispensável no lobby.",
