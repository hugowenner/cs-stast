    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div className="glass-panel border-white/[0.07] p-4 rounded-2xl flex flex-col justify-between hover:border-white/[0.1] transition-all min-h-[220px]">
        <div>
          <div className="flex items-center justify-between mb-3">
            <div>
              <p className="text-[8px] font-bold uppercase tracking-[0.12em] text-muted-foreground/50">Quadro de Honra</p>
              <h3 className="text-sm font-black text-white">Líderes da Temporada</h3>
            </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <h3 className="text-sm font-black text-white">Reis dos Mapas</h3>
            </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 min-w-0">
                <span className="text-xs shrink-0" aria-hidden>🔥</span>
                <div className="min-w-0">
                  <p className="text-[8px] uppercase tracking-wider font-bold text-muted-foreground/50 leading-none mb-0.5">Hot Streak</p>
                  {activeHotStreak ? (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 min-w-0">
                <span className="text-xs shrink-0" aria-hidden>📈</span>
                <div className="min-w-0">
                  <p className="text-[8px] uppercase tracking-wider font-bold text-muted-foreground/50 leading-none mb-0.5">Maior Evolução</p>
                  {bestEvolution ? (
      ...
      <div className="glass-panel border-white/[0.07] p-4 rounded-2xl flex flex-col justify-between hover:border-white/[0.1] transition-all min-h-[220px]">
        <div>
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-[8px] font-bold uppercase tracking-[0.12em] text-muted-foreground/50">Química de Equipe</p>
              <h3 className="text-sm font-black text-white">Melhores Conexões</h3>
            </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 min-w-0">
                <span className="text-xs shrink-0" aria-hidden>🤝</span>
                <div className="min-w-0">
                  <p className="text-[8px] uppercase tracking-wider font-bold text-muted-foreground/50 leading-none mb-0.5">Melhor Dupla (Season)</p>
                  {primaryDuo ? (
