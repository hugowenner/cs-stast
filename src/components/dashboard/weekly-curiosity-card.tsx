...
const CATEGORY_META: Record<WeeklyCuriosityCategory, { icon: any; label: string; color: string }> = {
  ...
  "streak-cold": { icon: Snowflake, label: "Sequência negativa", color: "text-status-critical" },
  map: { icon: Map, label: "Domínio de mapa", color: "text-accent-cyan" },
  adr: { icon: TrendingUp, label: "ADR em alta", color: "text-status-good" },
  "weekly-kills": { icon: Crosshair, label: "Top kills da semana", color: "text-status-warning" },
  "headshot-king": { icon: Crosshair, label: "Rei do HS", color: "text-accent-cyan" },
  "impact-beast": { icon: Zap, label: "Impacto alto", color: "text-primary" },
  "duo-perfect": { icon: Swords, label: "Dupla em alta", color: "text-accent-violet" },
};
